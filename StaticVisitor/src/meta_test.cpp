...
/** is_associative_container_v tests: */
static_assert(is_associative_container_v<std::map<int, int>>, "map is an associative container");
static_assert(is_associative_container_v<std::map<std::string, int>>, "map with string keys is an associative container");
static_assert(is_associative_container_v<std::map<int, int>&>, "reference to map is an associative container");
static_assert(is_associative_container_v<std::map<int, int>&&>, "rvalue reference to map is an associative container");
static_assert(is_associative_container_v<const std::map<int, int>>, "const map is an associative container");
static_assert(is_associative_container_v<const std::map<int, int>&>, "const reference to map is an associative container");
static_assert(is_associative_container_v<std::unordered_map<int, int>>, "unordered_map is an associative container");

static_assert(!is_associative_container_v<std::vector<int>>, "vector is not an associative container");
static_assert(!is_associative_container_v<std::set<int>>, "set is not an associative container");
static_assert(!is_associative_container_v<std::vector<std::pair<int, int>>>, "vector of pairs is not an associative container");
