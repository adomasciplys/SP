...
{ /** public access is just for easy structured initialization in tests */
    ...
    void accept(Visitor&& v) const  // NOLINT
    {
        v.visit("b", b);
        v.visit("x", x);
        v.visit("y", y);
    ...
    friend bool operator==(const Aggregate& a1, const Aggregate& a2)
    {
...
struct Nested
{
    ...
    /** equality operator to support testing */
    friend bool operator==(const Nested& n1, const Nested& n2) { return (n1.text == n2.text) && (n1.agg == n2.agg); }
};
